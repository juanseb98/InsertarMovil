...
//<---- Metodos ---->
    ...
    private void initComponents() {
        ...
        jLabeld.setText("ID");
        getContentPane().add(jLabeld, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, -1, -1));
        ...
        getContentPane().add(txtPeso, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 170, 70, -1));
        getContentPane().add(txtPulgadas, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 200, 70, -1));
        getContentPane().add(txtREsolucion, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 230, 150, -1));
        getContentPane().add(txtAlmacenamiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 270, 70, -1));
        ...
        getContentPane().add(cbProcesador, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 360, 236, -1));
        ...
        getContentPane().add(txtBateria, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 490, 90, -1));

        btInsertar.setText("Añadir movil");
        getContentPane().add(btInsertar, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 520, 191, -1));
